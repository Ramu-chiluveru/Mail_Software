      ...
      <section class="main-container">
        ...
        <div class="inbox">
          ...
          try{
            ...
            String sql ="select * from mails where mto='"+mfrom+"' and inbox=1";
            ...
            while(resultSet.next())
            {
              ...
              <div class="content">
                ...
                <%
                  ...
                  %>
                <a href="viewMail.jsp?mfrom=<%=mf%>&mto=<%=mto%>&subject=<%=subject%>&message=<%=message%>&target=0&id=<%=id%>"><span><%=resultSet.getString("content")%></span></a>
...
<script>
  ...
  {
    del[i].addEventListener("change", (e)=>{console.log(e.value)})
  } 
