    ...
    <%
      ...
      <section class="sidebar">
        ...
        <ul class="nav-menu">
          ...
          <li><a href="trash.jsp" class="active">Trash</a></li>
      ...
      <section class="main-container">
        ...
        <div class="inbox">
          ...
          try{
            ...
            String sql ="select * from mails where mto='"+mfrom+"' and sentbox=0 or mfrom='"+mfrom+"' and inbox=0";
            ...
            while(resultSet.next())
            {
              ...
              <div class="content">
                ...
                <span><%=resultSet.getString("content")%></span>
